...
{
	public class MedicalRecordServiceChannel : IMedicalRecordServiceChannel
	{

		private readonly IHttpClientFactory _httpFactory;
		private string _connectionString { get; set; }

		public MedicalRecordServiceChannel(IHttpClientFactory httpFactory, string connectionString)
		{
